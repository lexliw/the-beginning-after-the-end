...
for i in range(len(onlyfolders)):
    ...
    anterior = '/the-beginning-after-the-end/'
    proximo = '/the-beginning-after-the-end/'
    menu = '/the-beginning-after-the-end/'
    if i - 1 >= 0: 
        anterior = f'/the-beginning-after-the-end/{onlyfolders[i-1]}/'
    if i + 1 <= len(onlyfolders)-1: 
        proximo = f'/the-beginning-after-the-end/{onlyfolders[i+1]}/'
